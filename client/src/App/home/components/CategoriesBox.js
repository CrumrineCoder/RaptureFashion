...
class CategoriesBox extends Component {
    ...
    render() {
        ...
        return (
            <Link onMouseEnter={this.hoverStart} onMouseLeave={this.hoverEnd} className="categoriesBox" to={"/categories/" + this.props.category} >
                <div>
                    ...
                    <p className="categoriesBoxTag">{String(this.state.hover)}</p>
                </div>
